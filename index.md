...
__当`指定链接`URI的协议为`mailto` 时__，网易大神会用
[内置浏览器](#242-内置浏览器)间接打开邮件服务器链接，此处邮件服务器链接可以是任何省略`http` `https`协议的URI，
并且链接不在关键词静默管制范围内，可以用此方法发出任何链接。<br /><br >
